  ...
  const serversData = [
    {
      ...
      schoolType: "OLDSCHOOL" as const,
      gameplayDifficulty: "MEDIUM" as const,
      maxLevel: 120,
      ...
      members: [
        ...
        { userId: creator2.id, role: "ADMINISTRATOR" as const },
        { userId: creator3.id, role: "PROMOTER" as const },
        { userId: user1.id, role: "CONTENT_CREATOR" as const },
      ],
    },
    {
      ...
      schoolType: "OLDSCHOOL" as const,
      gameplayDifficulty: "PVP" as const,
      maxLevel: 105,
      representsServer: true,
      ...
      members: [
        ...
        { userId: creator1.id, role: "ADMINISTRATOR" as const },
        { userId: user2.id, role: "PROMOTER" as const },
        { userId: user3.id, role: "CONTENT_CREATOR" as const },
      ],
    },
    {
      name: "Mystic Realm",
      ...
      schoolType: "MIDDLESCHOOL" as const,
      gameplayDifficulty: "FARM" as const,
      maxLevel: 120,
      representsServer: true,
      ...
      members: [
        ...
        { userId: user4.id, role: "CONTENT_CREATOR" as const },
      ],
    },
    {
      name: "Nova School",
      ...
      mainLanguage: "English",
      supportedLanguages: ["English"],
      schoolType: "NEWSCHOOL" as const,
      gameplayDifficulty: "EASY" as const,
      maxLevel: 150,
      representsServer: false,
      ...
      members: [
        { userId: creator1.id, role: "OWNER" as const },
        { userId: user5.id, role: "PLAYER" as const },
      ],
    },
    {
      name: "Iron Forge",
      ...
      schoolType: "MIDDLESCHOOL" as const,
      gameplayDifficulty: "PVP_FARM" as const,
      maxLevel: 120,
      representsServer: true,
      ...
      members: [
        { userId: creator2.id, role: "OWNER" as const },
        { userId: creator3.id, role: "CO_OWNER" as const },
        { userId: user2.id, role: "COMMUNITY_MANAGER" as const },
      ],
    },
  ];
